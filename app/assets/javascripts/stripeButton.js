...
$(document).ready(function(){
  ...
  $("#bottom_boost").on("click", "button", function(e){
    ...
    $.ajax({
      ...
      url: Url,
      data: {boost:{current_rank: $("select#current_rank").children("option:selected").text(), desired_rank: $("select#desired_rank").children("option:selected").text(),queue: $("select#queue").children("option:selected").text()}},
      type: "POST",
      success: function(){
        console.log("success") 
      }
